<template>
  <view class="container" :style="themeVars">
    <view class="itemWrapper" style="background: #f7f7f7; line-height: 1.5">
      为了您的账户安全，需要向当前门店负责人手机号发送验证码，请注意短信查收。
    </view>
    <view class="itemWrapper">
      ...
      <view class="item check">
        <view :class="['button', ' button--large', CherkCode ? '' : 'disabled']" @tap="CherkPhoneMessage">
          立即验证
        </view>
      </view>
    </view>
...
export default {
  ...
  data() {
    return {
      RoleType: '', // 角色类型必须为 0 门店 1 分销员 2 直营经销商 3 门店直营分佣钱包 4 门店渠道推广
      Headpath: '',
      NickName: '',
  ...
  methods: {
    ...
    CherkPhoneMessage() {
      ...
      this.handleCherkPhone(this.openid, this.Headpath, this.NickName, this.CherkCode, 4)
    },
